...
func _input(event):
	if current_gameboard_state == GAMEBOARD_STATE.ACTIVE:
...
# State Helper ===========================
func init(_word: String, _Scoreboard: Node2D, _LettersUsed: Node2D):
	Scoreboard = _Scoreboard
	LettersUsed = _LettersUsed
	word = _word
	...
	current_gameboard_state = GAMEBOARD_STATE.ACTIVE
